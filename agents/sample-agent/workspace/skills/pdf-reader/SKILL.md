...
1. **Ensure PDF path is under workspace** (e.g. `/home/ai_sandbox/.openclaw/workspace/...`). If the user shared a file, use the path the gateway provides.
2. **Run the extraction script:**
   ```
   python3 /home/ai_sandbox/.openclaw/workspace/skills/pdf-reader/scripts/extract_text.py <path-to-pdf>
   ```
...
2. **Run the PDF-to-images script:**
   ```
   python3 /home/ai_sandbox/.openclaw/workspace/skills/pdf-reader/scripts/pdf_to_images.py <path-to-pdf> --output-dir /home/ai_sandbox/.openclaw/workspace/skills/pdf-reader/pages/<run-id> [--format png|jpeg] [--dpi 150] [--max-pages 50]
   ```
...
```
python3 /home/ai_sandbox/.openclaw/workspace/skills/pdf-reader/scripts/gc_pdf_images.py
```
